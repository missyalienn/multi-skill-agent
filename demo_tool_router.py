"""
Demonstrates Semantic Tool Selection across three tool categories
...
tools = [
    ToolSpec(
        ...
        category=ToolCategory.HAND_CRAFTED,
    ...
    ToolSpec(
        ...
        category=ToolCategory.API_BASED,
