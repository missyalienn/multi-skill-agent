"""
Semantic Skill Selection (book Ch. 5: Orchestration).
...
most relevant tool(s) by cosine similarity. The book calls this the most
common, most recommended pattern for skill selection -- faster and more
scalable than letting the model freely reason over every tool every time.
